"""
Django settings for kb_calculate project.
...
SECRET_KEY = 'o*0%v--&@@lv3v$^2tcqjdersgupacke!73hjs8-hacw)ju(_#'
...
ROOT_URLCONF = 'kb_calculate.urls'
...
WSGI_APPLICATION = 'kb_calculate.wsgi.application'
